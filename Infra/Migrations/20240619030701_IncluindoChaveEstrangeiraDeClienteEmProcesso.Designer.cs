...
namespace Infra.Migrations
{
    ...
    [Migration("20240619030701_IncluindoChaveEstrangeiraDeClienteEmProcesso")]
    partial class IncluindoChaveEstrangeiraDeClienteEmProcesso
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Entidades.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("RefreshToken")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("USR_REFRESHTOKEN");

                    b.Property<DateTime?>("RefreshTokenExpiryTime")
                        .HasColumnType("datetime2")
                        .HasColumnName("USR_REFRESHTOKENEXPIRYTIME");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "709cc417-4e76-4e15-83e1-a616197dfdad",
                            ConcurrencyStamp = "1f5951db-5c06-4de0-89c3-42a66333b1d5",
                            Name = "Usuário",
                            NormalizedName = "USUÁRIO"
                        },
                        new
                        {
                            Id = "d60bdd70-bcd9-4650-b527-1fe2a9203f89",
                            ConcurrencyStamp = "ca8a5108-9709-4bf1-a47a-935248604bdd",
                            Name = "Admin",
            ...
            modelBuilder.Entity("Justo.Entities.Entidades.Processo", b =>
                {
                    ...
                    b.HasOne("Justo.Entities.Entidades.Cliente", "Cliente")
                        .WithMany()
